...
def _get_GT():
    ...
    GT_dict['type_tower'] = ["tower", "squares"]
    ...
    GT_dict["aggregates_[900]"] = ["stack", "stacks"]

#    GT_dict["superlatives_0"] = ["closest"]
#    GT_dict["superlatives_0"] = ["closest"]
#    GT_dict["(10,10),(20,10),(30,10),(40,10),(50,10),(60,10),(70,10),(80,10)"] = ["rightmost"]
...
hypotheses_tags["rows"]["aggregates_[90]"] = 0.0 #changed from rows
hypotheses_tags["column"]["aggregates_[0]"] = 0.0#changed from columns
#hypotheses_tags["stacks"]["aggregates_[900]"]
