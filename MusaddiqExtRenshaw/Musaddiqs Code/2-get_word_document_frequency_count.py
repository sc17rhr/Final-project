# this file is used to get the word to document frequency
# this is a count of the total number of documents provided in the dataset
# and the number of times a word appears in them
import operator
import pickle
import numpy as np
...
def _read_pickle(scene):
    pkl_file = '/mnt/c/Users/The Rench/Final_Project/Datasets/Dataset1/scenes' + str(
        scene) + '_sentences.p'
...
if "leftmost" in FW:
    print "leftmost in FW"
if "most left" in FW:
    print "rightmost in FW"
print FW
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
