...
def read_data():
    ...
    Data['RCL'] = {}
    tree = ET.parse('/mnt/c/Users/The Rench/Final_Project/Datasets/Dataset1/treebank/losr.xml')
    root = tree.getroot()
    for child in root:
    ...
    tree = ET.parse('/mnt/c/Users/The Rench/Final_Project/Datasets/Dataset1/treebank/commands.xml')
    root = tree.getroot()
    Data[root.tag] = {}
    Data['commands_id'] = {}
    for child in root:
    ...
    tree1 = ET.parse('/mnt/c/Users/The Rench/Final_Project/Datasets/Dataset1/treebank/comments.xml')
    root1 = tree1.getroot()
    Data['comments'] = {}
    for child in root1:
        Id = int(child.attrib['id'])
    ...
    Data['layouts'] = {}
    Data['gripper'] = {}
    tree = ET.parse('/mnt/c/Users/The Rench/Final_Project/Datasets/Dataset1/treebank/layouts.xml')
    root = tree.getroot()
    for child in root:
        counter = 0
        Id = int(child.attrib['id'])
    ...
    Data['scenes'] = {}
    tree = ET.parse('/mnt/c/Users/The Rench/Final_Project/Datasets/Dataset1/treebank/scenes.xml')
    root = tree.getroot()
    for child in root:
        Id = int(child.attrib['id'])
        Data['scenes'][Id] = {}
